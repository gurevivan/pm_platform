"""
Настройки Django: PostgreSQL через переменные окружения и REST/OpenAPI/JWT/CORS.
"""
...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY", "django-insecure-dev-change-me-not-for-production"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Проекты и задачи (REST API v1)",
    "VERSION": "1.0.0",
...
_https_enabled = os.getenv("SECURE_SSL_REDIRECT", "0") == "1"
